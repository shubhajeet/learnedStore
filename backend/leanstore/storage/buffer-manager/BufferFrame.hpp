...
// -------------------------------------------------------------------------------------
struct BufferFrame {
   // enum class STATE : u8 { FREE = 0b0, HOT = 0b10, COOL = 0b100, LOADED = 0b1, UNLINKED_HOT = 0b1011, UNLINKED_COOL = 0b1101 };
   enum class STATE : u8 {
      FREE = 0b0,
      HOT = 0b10,
      COOL = 0b01,
   ...
   struct Header {
      ...
      u64 debug;
      // -------------------------------------------------------------------------------------
      // just to avoid hashtable lookup
      std::vector<size_t>* attached_segments = nullptr;
      spline::RadixSpline<KEY> splines;
