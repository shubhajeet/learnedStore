...
// -------------------------------------------------------------------------------------
struct Partition {
   // MyNote:: list of page id requested
   std::mutex io_mutex;
   HashTable io_ht;
   // -------------------------------------------------------------------------------------
   // MyNote:: cooling stage bufferframe list but not sure why we need mutex
   ...
   // pushes pid to freed_pids vector
   ...
   u64 freeDRAM() { return dram_free_list.counter; }
   // -------------------------------------------------------------------------------------
