...
namespace jumpmu
{
// MyNote:: thread specific global variables
...
void jump();
// MyNote: uses de_stack_obj and de_stack_arr
...
// destack_array contains des function pointer
// destack_obj contains JMUW object
...
// MyNote:: Not sure why would we need this
template <typename T>
class JMUW
{
  public:
